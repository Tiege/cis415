/***TREVOR JONES *** tjones9 *** PROJECT 1 *** THV(3) *** CIS 415*******
*This source file is my own original work. This is a process scheduler using
*a round robin scheme. The program reads arguements from the cmdline then
...
/*main parent process****************************************
*this main function sets up our parameters for our process scheduling
*it reads input args from the cmdline and forks as many children processes using 'command' as specified. If no arguements are given, environment variables are used. The elapsed time is measured and displayed before the parent process exits after each child is terminated.********/
